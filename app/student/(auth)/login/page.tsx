...
export default function StudentLoginPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
       ...
       * Student login only.
       *
       * If another role tries to use this page,
       * do not allow them into Student Dashboard.
       */
      if (response.role !== "STUDENT") {
        setError(
          "This login is only for student accounts."
        );
        return;
      }
          ...
          <div className="relative flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-lg">
              ...
              <p className="mt-5 text-base leading-7 text-slate-400">
                Welcome to your HIKOO student portal. Manage your
                courses, attendance, certificates and learning
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Login to continue your HIKOO learning journey.
              </p>
            </div>
