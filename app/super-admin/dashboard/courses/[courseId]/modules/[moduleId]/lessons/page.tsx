...
export default function LessonsPage() {
  ...
  async function loadData() {
    try {
      ...
      const [moduleData, lessonData] = await Promise.all([
        getCourseModule(moduleId),
        getCourseLessons(moduleId),
      ]);
  ...
  async function handleSaveLesson(
    ...
    try {
      ...
      if (editingLesson) {
        ...
        const createdLesson = await createCourseLesson({
          moduleId: moduleId,
          title: title.trim(),
          description: description.trim(),
          lessonOrder: order,
  ...
  async function handleToggleStatus(
    ...
    try {
      ...
      await updateCourseLessonStatus(
        lesson.id,
        !lesson.active
      );
  ...
  function goBackToModules() {
    router.push(
      `/super-admin/dashboard/courses/${courseId}/modules`
    );
  }
