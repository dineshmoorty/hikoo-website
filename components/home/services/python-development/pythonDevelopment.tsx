        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-gray-600">
              We use Python to build flexible applications, backend
              systems, APIs, and automation solutions that help
              businesses simplify workflows and create new
              possibilities.
            </p>
          </div>
        </div>
